...
public class Izrazi_G {
	...
	public static void OBRADI_primarni_izraz(boolean dajAdresu){
		...
		if (uz.mNaziv.equals("IDN")){
			if (NaredbenaStrukturaPrograma_G.mStog != null){ // jesmo li u globalnom djelokrugu ili u funkciji
				int i = NaredbenaStrukturaPrograma_G.PretraziIme_Lok(uz.mLeksickaJedinka);
				if (i == -1){ // trazena varijabla mora biti u globalnom djelokrugu
					i = NaredbenaStrukturaPrograma_G.PretraziIme_Glo(uz.mLeksickaJedinka);
					...
					novi.mIme = null;
					novi.mAdresa = NaredbenaStrukturaPrograma_G.mGlobalniDjelokrug.get(i).mAdresa;
					novi.mVelicina = NaredbenaStrukturaPrograma_G.mGlobalniDjelokrug.get(i).mVelicina;
					NaredbenaStrukturaPrograma_G.mStog.add(novi);
				}else{ // trazena varijabla je u lokalnom djelokrugu
					int dubina = NaredbenaStrukturaPrograma_G.DajDubinuOdVrhaStoga(i);
					if(dajAdresu){
					...
					Ime_Velicina_Adresa novi = new Ime_Velicina_Adresa();
					novi.mIme = null;
					novi.mAdresa = NaredbenaStrukturaPrograma_G.mStog.get(i).mAdresa;
					novi.mVelicina = NaredbenaStrukturaPrograma_G.mStog.get(i).mVelicina;
					NaredbenaStrukturaPrograma_G.mStog.add(novi);
				}
				return;
			}else{
				// trazena varijabla mora biti u globalnom djelokrugu ako je i trenutno analizirani dio koda
				int i = NaredbenaStrukturaPrograma_G.PretraziIme_Glo(uz.mLeksickaJedinka);
	...
	public static void OBRADI_unarni_izraz(boolean dajAdresu, boolean staviNaStog){
		...
		if (linija.equals("<unarni_operator>")){
			...
			if (NaredbenaStrukturaPrograma_G.mStog != null){ // u globalnom djelokrugu
